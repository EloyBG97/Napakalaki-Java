...
public class Player {
    ...
    private BadConsecuence pendingBadConsecuence;
    ...
    private void setPendingBadConsecuence(BadConsecuence b){
        pendingBadConsecuence = b;
    }
    ...
    public boolean validState(){
        return (hiddenTreasures.size() <= 4 && pendingBadConsecuence.isEmpty());
    }
