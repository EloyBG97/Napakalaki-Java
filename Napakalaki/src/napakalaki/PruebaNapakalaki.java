...
public class PruebaNapakalaki {
    ...
    public static void addMonsters(){
        ...
        monstruos.add(new Monster("3 Byakhees de bonanza",8,bc,new Prize(2,1),0));
        ...
        monstruos.add(new Monster("Tenochtitlan",2,bc,new Prize(1,1),0));
        ...
        monstruos.add(new Monster("El sopor de Dunwich",2,bc,new Prize(1,1),0));
        ...
        monstruos.add(new Monster("Dameargo",1,bc,new Prize(2,1),0));
        
        
        bc = new BadConsequence("Da mucho asquito. Pierdes 3 niveles",3,0,0);
        monstruos.add(new Monster("Pollipólipo volante",3,bc,new Prize(2,1),0));
        
        
        bc = new BadConsequence("No le hace gracia que pronuncien mal su nombre. Estas muerto",true);
        monstruos.add(new Monster("Yskhtihyssg-Goth",14,bc,new Prize(3,1),0));
        
        
        bc = new BadConsequence("La familida te atrapa. Estas muerto",true);
        monstruos.add(new Monster("Familia feliz",1,bc,new Prize(3,1),0));
        ...
        monstruos.add(new Monster("Roboggoth",8,bc,new Prize(2,1),0));
        
        
        bc = new BadConsequence("Te asusta en la noche. Pierdes un casco visible",
            0,new ArrayList(Arrays.asList(TreasureKind.HELMET)),new ArrayList());
        monstruos.add(new Monster("El espía sordo",5,bc,new Prize(1,1),0));
        
        
        bc = new BadConsequence("Menudo susto te llevas. Pierdes 2 niveles y 5 tesoros visibles",2,5,0);
        monstruos.add(new Monster("Tongue",19,bc,new Prize(2,1),0));
        ...
        monstruos.add(new Monster("Bicéfalo",21,bc,new Prize(2,1),0));
    }
